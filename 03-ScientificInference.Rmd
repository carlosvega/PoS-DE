...
<video width="500"
  frameborder="0" controls autoplay>
...
The frequentist computes the probability of result or data $D$ given hypothesis $H$ is true, i.e. $P(D|H)$. In comparison, the Bayesian approach focus on the probability of hypothesis $H$ when the result pr data $D$ occurs, i.e. $P(H|D)$ [@orloffcomparison].
::::
...
[continue] example for falsification
