...
(ref:greenland) These maps show two different approaches to depicting Greenland. The left map is an orthographic projection, emulating a globe. The right map is a Mercator projection, which exaggerates the sizes of landmasses — including Greenland. Alyson Hurt / NPR
...
4. In your opinion, when does data stop describing reality and start constructing it?
...
<figcaption>Rhazes, a physician, examines a kneeling boy who has his mouth wide open, they are in a surgery full of equipment.</br></figcaption>
</figure>'
)
```
...
- Identify the **epistemic role of a proxy** and distinguish it from direct measurement.
...
4. Give one example of how Ibn Sina’s critique applies to modern data science or machine learning.
...
Nightingale collected detailed hospital records and noticed that most deaths occurred away from the battlefield. Rather than relying on total death counts, she reorganised the data by *cause of death* and *time period*. She then compared mortality patterns before and after sanitation reforms, using innovative visualisations to communicate her findings.
...
1. Why were raw mortality numbers insufficient to support Nightingale’s conclusions?  
...
- Link ethical significance to **prevention capacity**, responsibility, and policy impact.
...
### Ignaz Goldziher: From Textual Corpora to Historical Claims
...
1. Why were common exposures alone insufficient to identify causes of breast cancer?  
