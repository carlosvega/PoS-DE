...
This tool should help you spotting what assumptions were made, how evidence was connected to theory, whether the conclusions follow logically. This program or tool, comes from the book "Understanding scientific reasoning" from Ronald N. Giere, John Bickle and Robert F. Mauldin [@giere2006understanding].
...
- **Step 5: Negative Evidence?** Do the data and prediction agree? If no then, negative evidence, the model likely does not fit the real world. If yes, go to step 6.
...
```{python, results = 'hide', error=FALSE, warning=FALSE, message=FALSE}
