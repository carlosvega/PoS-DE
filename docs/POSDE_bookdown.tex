...
\subsection{Hempel's model limitations}\label{hempels-model-limitations}
...
However, his model is too liberal.
...
\subsection{Modern views}\label{modern-views}
