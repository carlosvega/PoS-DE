...
\tightlist
\item
  *Infinitism\textbf{ embraces an epistemic view that challenges the premise that inference \texttt{I} presupposes UP, since, after all, the future only resembles the past in some respects, but not others. Maybe inductive inferences do not rely in a common UP, but rather, each inductive inference depends on separate empirical presuppositions \citep{sep-induction-problem}, }replacing the justification circularity problem with an infinite regress**.
\item
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.2081}}
...
\pandocbounded{\includegraphics[keepaspectratio]{POSDE_bookdown_files/figure-latex/unnamed-chunk-34-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{POSDE_bookdown_files/figure-latex/unnamed-chunk-34-2.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{POSDE_bookdown_files/figure-latex/unnamed-chunk-40-5.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{POSDE_bookdown_files/figure-latex/unnamed-chunk-40-6.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{POSDE_bookdown_files/figure-latex/unnamed-chunk-49-9.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{POSDE_bookdown_files/figure-latex/unnamed-chunk-49-10.pdf}}
